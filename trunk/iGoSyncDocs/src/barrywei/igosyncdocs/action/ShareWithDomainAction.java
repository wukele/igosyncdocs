/**
 * @(#)ShareWithDomainAction.java Jul 16, 2010
 ...
 * @since JDK1.6
 */
public class ShareWithDomainAction implements ActionListener,Runnable{

	private ShareWithDomainDialog dialog = null;
	...
	public ShareWithDomainAction(ShareWithDomainDialog dialog,
	...
	private void addAclEntry() {
		...
		try {
			for (String email : address) {
				...
				AclScope scope = new AclScope(AclScope.Type.DOMAIN, email);
