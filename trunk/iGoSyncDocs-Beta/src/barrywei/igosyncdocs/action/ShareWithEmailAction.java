/**
 * @(#)ShareWithEmailAction.java Jul 16, 2010
 ...
 * @since JDK1.6
 */
public class ShareWithEmailAction implements ActionListener, Runnable {
	...
	public ShareWithEmailAction(ShareWithEmailDialog dialog,
			IGoSyncDocsRemoteViewTableItem item,int type) {
		try {
			this.dialog =  dialog;
